(async () => {
    ...
    const sounds = {
        "Rood": new Audio("my_sounds/ROOD.mp3"),
        "Green": new Audio("my_sounds/GREEN.mp3"),
        
    };

    const images = {
       "Rood": "my_images/roodvlak.png",
       "Green": "my_images/greenvlak.png",
       "Neutral": "my_images/neutralvlak.png",
    };
